...
/**
 * TaskFlow AI MCP Server - Standalone Version
 * This version runs directly on the host for easier Claude Desktop integration
 */
...
class TaskFlowMCPServer {
      ...
      return {
        tools: [
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                area: { type: 'string', description: 'Area or category' },
              },
              required: ['id'],
              additionalProperties: false,
            },
          },
          {
            ...
            inputSchema: {
              type: 'object',
              properties: { id: { type: 'number', description: 'Task ID (required)' } },
              required: ['id'],
              additionalProperties: false,
            },
          },
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                status: { type: 'string', enum: ['active', 'completed', 'archived'], description: 'Project status', default: 'active' },
                tags: { type: 'array', items: { type: 'string' }, description: 'Tags' },
                area: { type: 'string', description: 'Area or category' },
              },
              required: ['name'],
          ...
          },
          {
            ...
            inputSchema: {
              type: 'object',
              properties: {
                content: { type: 'string', description: 'Scrap content (required)' },
                date_assigned: { type: 'string', format: 'date', description: 'Date assigned (YYYY-MM-DD)' },
              },
              required: ['content'],
              additionalProperties: false,
            },
          },
          {
            ...
            inputSchema: {
              type: 'object',
              properties: { processed: { type: 'boolean', description: 'Filter by processed status' } },
              additionalProperties: false,
            },
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                area: {
                  type: 'string',
                  description: 'Filter by area or category',
                },
                date_assigned: {
                  type: 'string',
                  format: 'date',
                  description: 'Filter by date assigned (YYYY-MM-DD)',
                },
              },
              additionalProperties: false,
            },
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                date_assigned: { type: 'string', format: 'date', description: 'Date assigned (YYYY-MM-DD)' },
                date_range_end: { type: 'string', format: 'date', description: 'End date for date range (YYYY-MM-DD)' },
                tags: { type: 'array', items: { type: 'string' }, description: 'Tags' },
                area: { type: 'string', description: 'Area or category' },
              },
              required: ['id'],
          ...
          },
          {
            ...
            inputSchema: {
              type: 'object',
              properties: { id: { type: 'number', description: 'Note ID (required)' } },
              required: ['id'],
              additionalProperties: false,
            },
          },
  ...
  async getTasks(args) {
    ...
    return {
      content: [{ type: 'text', text: `Found ${data.length} tasks:\n${JSON.stringify(data, null, 2)}` }],
    };
  }
  ...
  async deleteTask(args) {
    await this.makeApiCall(`/api/tasks/${args.id}`, { method: 'DELETE' });
    return {
  ...
  async getProjects(args) {
    ...
    return {
      content: [{ type: 'text', text: `Found ${data.length} projects:\n${JSON.stringify(data, null, 2)}` }],
    };
  }
...
${JSON.stringify(data, null, 2)}`;
  ...
  async createScrap(args) {
    ...
    return {
      content: [{ type: 'text', text: `Scrap created successfully:\n${JSON.stringify(data, null, 2)}` }],
    };
  }
  ...
  async getScraps(args) {
    ...
    return {
      content: [{ type: 'text', text: `Found ${data.length} scraps:\n${JSON.stringify(data, null, 2)}` }],
    };
  }
  ...
  async getNotes(args) {
    ...
    return {
      content: [{ type: 'text', text: `Found ${data.length} notes:\n${JSON.stringify(data, null, 2)}` }],
    };
  }
  ...
  async deleteNote(args) {
    await this.makeApiCall(`/api/notes/${args.id}`, { method: 'DELETE' });
    return {
...
module.exports = { TaskFlowMCPServer };